...
{
    public async Task<SupplierUpdateStatus> UpdateSupplierAsync(string supplierName, int? supplierId = null)
    {
        ...
        if (supplierId == null)
        {
            ...
            return SupplierUpdateStatus.Success;
        }
        ...
        if (existingSupplier == null)
        {
            ...
            return SupplierUpdateStatus.NotFound;
        }
